...
namespace RavenDevLauncher.Network
{
    public class NetworkClient : NetworkEx
    {
        private INIFile ini = new INIFile(".\\R3Engine.ini");
        ...
        private void SelectWorldResult(Socket client, byte[] pMsg)
        {
            ...
            if (selectWorldResult.byRetCode == 0)
            {
                ...
                //_defaulSet.nation_code = (ushort)e_nation_code.en_gb;
                ...
                string text = ini.ReadValue("Setup", "Language");
                ...
                else
                {
                    ...
                    {
                        case "Korea": //Korea
                            _defaulSet.nation_code = (ushort)e_nation_code.ko_kr;
                            break;
                        case "Brazil": //Brazil
                            _defaulSet.nation_code = (ushort)e_nation_code.pt_br;
                            break;
                        case "China": //China
                            _defaulSet.nation_code = (ushort)e_nation_code.zn_cn;
                            break;
                        case "Europe": //Europe
                            _defaulSet.nation_code = (ushort)e_nation_code.en_gb;
                            break;
                        case "Indonesia": //Indonesia
                            _defaulSet.nation_code = (ushort)e_nation_code.en_id;
                            break;
                        case "Japan": //Japan
                            _defaulSet.nation_code = (ushort)e_nation_code.ja_jp;
                            break;
                        case "Philippines": //Philippines
                            _defaulSet.nation_code = (ushort)e_nation_code.en_ph;
                            break;
                        case "Russia": //Russia
                            _defaulSet.nation_code = (ushort)e_nation_code.ru_ru;
                            break;
                        case "Taiwan": //Taiwan
                            _defaulSet.nation_code = (ushort)e_nation_code.zh_tw;
                            break;
                        case "USA": //UnitedStates
                            _defaulSet.nation_code = (ushort)e_nation_code.es_es;
                            break;
                        case "Thailand": //Thailand
                            _defaulSet.nation_code = (ushort)e_nation_code.th_th;
                            break;
                        default:
                            _defaulSet.nation_code = (ushort)e_nation_code.en_gb;
                            break;
